...
const CIERuleComponentSchema = new mongoose_1.Schema({
    cieConfigurationId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'CIEConfiguration', required: true },
...
exports.default = mongoose_1.default.model('CIERuleComponent', CIERuleComponentSchema);
